                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>维修厂名称</label>
                      <input id="name" name="name" type="text" placeholder="请填写维修厂名称" value="" class="form-control"></input>
                    </div>
                    <div class="form-group">
                      <label>维修厂电话</label>
                      <div class="input-group">
                        ...
                        <input type="text" id="phone" name="phone" placeholder="请填写维修厂电话" value="" class="form-control"></input>
                      </div>
                    </div>             
                     <div class="form-group">
                      <label>维修厂地址</label>
                      <input type="text" id="location" name="location" placeholder="请填写维修厂地址" value="" class="form-control"></input>
                    </div>                   
                  </div>
                  <!--第二列-->
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>维修厂联系人</label>
                      <input type="text" id="linkman" name="linkman" placeholder="请填写维修厂联系人" value="" class="form-control"></input>
                    </div>
                     <div class="form-group">
                      <label>维修厂传真</label>
                      <div class="input-group">
                        ...
                        <input type="text" id="fax" name="fax" placeholder="请填写维修厂传真" value="" class="form-control"></input>
                      </div>
                    </div>             
                  </div>
                  <!--第三列-->
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>维修厂邮箱</label>
                      <input type="text" id="email" name="email" placeholder="请填写维修厂邮箱" value="" class="form-control"></input>
                    </div>
                    <div class="form-group">
                      <label>移动电话</label>
                      <div class="input-group">
                        ...
                        <input type="text" id="moblie_phone" name="moblie_phone" placeholder="请填写移动电话" value="" class="form-control"></input>
                      </div>
                    </div>    
                  </div>
                </div>
...
<script>
  ...
  //获取人员信息
    ...
    function  submit(data) {
        ...
        $.ajax({
            url: root+'/repair/repairFactoryPost',
            type: 'POST',
            dataType: 'json',
            data: data,
        }).done(function (data) {
