      ...
      <div class="box box-default">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" id="tab_1">
            <input type="hidden" id="urll" value="${pageContext.request.contextPath}/repair/repairApplyCheck1No"/>
            <form method="post" id="1-1" action="${pageContext.request.contextPath}/repair/repairApplyCheck1Yes" >

              <div class="box-body">
                <input id="id" name="id" value="${repairApplyAll.id}" type="hidden"/>
                <div class="row">
                  <div class="col-md-4">
...
污点记录：${repairFactory.badContent}
                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="form-group">
                      <label>一审说明</label>
                      <textarea type="text" id="check_1_content" name="check1Content"  placeholder="请填写一审说明" style="width: 100%;"></textarea>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                    ...
                    &nbsp; &nbsp; &nbsp;
                    <button class="btn btn-block btn-danger btn-lg" id="btn" type="button" item-width="50%" onclick="getUrl();">
									    拒绝
  			            </button>
                  </div>
                </div>
