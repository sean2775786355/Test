      ...
      <div class="box box-default">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" id="tab_1">
            <input type="hidden" id="urll" value="${pageContext.request.contextPath}/repair/repairApplyCheck3No?id=${repairApplyAll.id}"/>
            <form method="POST" id="1-1"  action="${pageContext.request.contextPath}/repair/repairApplyCheck3Yes?id=${repairApplyAll.id}" >
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="form-group">
                      <label>维修厂信息</label>
                      <textarea disabled="disabled" type="text"  value="" style="width: 900px;height: 200px">
...
污点记录：${repairFactory.badContent}
                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="form-group">
                      <label>三审说明</label>
                      <textarea type="text" id="check_3_content" name="check3Content" value="" placeholder="请填写三审说明" style="width: 100%;"></textarea>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
