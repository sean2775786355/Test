        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">维修厂信息</h3>
                &nbsp; &nbsp; &nbsp;
              <a class="btn btn-app" href="${pageContext.request.contextPath}/repair/repairFactoryCreate" >
                <i class="fa fa-inbox"></i>新增维修厂
              </a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <th width="10%">编号</th>
                  <th width="15%">维修厂名称</th>
                  <th width="10%">联系人</th>
                  <th width="10%">电话</th>
                  <th width="15%">维修厂邮箱</th>
                  <th width="20%">维修厂说明</th>
                  <th width="20%">编辑</th>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${RepairFactoryList}" var="RepairFactory">
                	<tr>
                  <td>${RepairFactory.id}</td>
                  <td>${RepairFactory.name}</td>
                  <td>${RepairFactory.linkman}</td>
                  <td>${RepairFactory.phone}</td>
                  <td>${RepairFactory.email}</td>
                  <td>${RepairFactory.content}</td>
                  <td><a class="btn bg-maroon margin" href="${pageContext.request.contextPath}/repair/repairFactoryDelete?id=${RepairFactory.id}">删除</a>
                  		<a class="btn bg-purple margin" href="${pageContext.request.contextPath}/repair/repairFactoryDetail?id=${RepairFactory.id}">编辑</a></td>
                </tr>
                </c:forEach>
