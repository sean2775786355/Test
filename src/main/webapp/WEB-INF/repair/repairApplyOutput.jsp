...
<head>
  ...
  <script>
      function upload() {
          var filename = document.getElementById("finish_file").value;
      ...
      <div class="box box-default">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" id="tab_1">
            <form method="POST" id="" name="" action="${pageContext.request.contextPath}/repair/repairApplyOutputYes?id=${repairApplyAll.id}" >
              <div class="box-body">
...
污点记录：${repairFactory.badContent}
                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="form-group">
                      <label>维修单内容</label>
                      <textarea disabled="disabled" type="text" id="act_repair_content" name="act_repair_content" value="" placeholder="请填写维修单内容" style="width: 100%;">${repairApplyAll.actRepairContent}</textarea>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-8">
                    <div class="form-group">
                      <label>完工单内容</label>
                      <textarea type="text" id="finish_content" name="finish_content" value="" placeholder="请填写完工单内容" style="width: 100%;"></textarea>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>维修经费使用</label>
                      <input type="text" id="budget_usage_count" name="budget_usage_count" placeholder="请填写维修花费金额" value="" class="form-control"></input>
                    </div> 
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-4">
                    ...
                    <div class="form-group">
                      <label>完工单文件</label>
                      <input type="file" id="finish_file" name="finish_file"/>
                    </div>
                    </div>
                  </div>
                </div>
