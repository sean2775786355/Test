          ...
          <div class="tab-pane active" id="tab_1">
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="form-group">
                      <label>维修厂信息</label><br>
                      <textarea disabled="disabled" type="text"  style="width: 900px;height: 200px">
...
污点记录：${repairFactory.badContent}
                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="form-group">
                      <label>完工单内容</label>
                      <textarea disabled="disabled" type="text" id="finish_content" name="finish_content" value="" placeholder="请填写完工单内容" style="width: 100%;">${repairApplyAll.finishContent}</textarea>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>维修经费使用</label>
                      <input disabled="disabled" type="text" id="budget_usage_count" name="budget_usage_count" placeholder="请填写维修花费金额" value="${repairApplyAll.budgetUsageCount}" class="form-control" ></input>
                    </div> 
                  </div>
                </div>
              </div>
