      ...
      <div class="box box-default">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" id="tab_1">
            <input type="hidden" id="urll" value="${pageContext.request.contextPath}/repair/repairApplyCheck2No"/>
            <form method="POST" id="1-1"  action="${pageContext.request.contextPath}/repair/repairApplyCheck2Yes" >
              <div class="box-body">
...
污点记录：${repairFactory.badContent}
                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="form-group">
                      <label>二审说明</label>
                      <textarea type="text" id="check_2_content" name="check2Content" value="" placeholder="请填写二审说明" style="width: 100%;"></textarea>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
