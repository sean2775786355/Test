    ...
    <div class="content-wrapper">
      ...
      <ol class="breadcrumb">
        <li><a href="${pageContext.request.contextPath}/index"><i class="fa fa-dashboard"></i> 主页</a></li>
      	<li><a href="${pageContext.request.contextPath}/Boat/boatInfo/${id}">船舶信息</a></li>
        <li class="active">船舶预算</li>
      </ol>
    </section>
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_1" data-toggle="tab">船舶预算</a></li>
            </ul>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>船舶名称</label>
                      <input id="boat_id" name="boat_id" type="hidden" value="${id}">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>预算财年</label>
                      <input id="year" name="year" type="text" value="1" class="form-control"></input>
                    </div>        
                  </div>
                  <!--第二列-->
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>预算金额</label>
                      <input type="text" id="totaled" name="totaled" placeholder="请填写预算金额（人民币）" value="" class="form-control"></input>
                    </div> 
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-8">
                    <div class="form-group">
                      <label>预算说明</label>
                      <textarea type="text" id="content" name="content" value="" placeholder="请填写预算说明" style="width: 100%;"></textarea>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
    ...
    function  submit(data) {
        ...
        $.ajax({
            ...
            data: data,
                    ...
                    alert("预算信息已成功提交");
                    setTimeout(function () {
                        window.location.href=root+"/budget/budgetInfo?year=" + data.year;
                    },1000*2);
                    //刷新页面
                })
                .fail(function () {
