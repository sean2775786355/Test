                ...
                <div class="box-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="subject" name="subject"
                                       placeholder="请输入主题" value="${publish.subject}" disabled="disabled"/>
                            </div>
                            <div class="form-group">
                                <label>内容</label>
                                <textarea type="text" id="content" name="content" value="" placeholder="请填写内容"
                                          style="width: 100%;height: 50%"
                                          disabled="disabled">${publish.content}</textarea>
                            </div>
                            <!-- /.form-group -->
                            <!-- /.form-group -->
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="col-md-offset-12 col-md-9">
                            <c:if test="${publish.isReply==0}">
                                <c:if test="${publish.isForBoat==1&&captain==1}">
                                    <a class="btn btn-block btn-primary btn-lg" id="btn"
                                       item-width="50%"
                                       href="${pageContext.request.contextPath}/publish/publishCheck?publishId=${publish.id}">
                                        已确认全船人收到
                                    </a>
                                </c:if>
                                <c:if test="${publish.isForBoat==0}">
                                    <a class="btn btn-block btn-primary btn-lg" id="btn"
                                       item-width="50%"
                                       href="${pageContext.request.contextPath}/publish/publishCheck?publishId=${publish.id}">
                                        收到
