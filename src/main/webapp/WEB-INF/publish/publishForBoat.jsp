...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <!-- SELECT2 EXAMPLE -->
            <!-- form  -->
            <form action="${pageContext.request.contextPath}/publish/publishDo" method="post" role="form" >
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title">发布信息</h3>
                        <input type="hidden" id="isForBoat" name="isForBoat" value="1"/>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>主题</label>
                                    <input class="form-control" type="text" id="subject" name="subject" placeholder="请输入主题"/>
                                </div>
                                <div class="form-group">
                                    <label>内容</label>
                                    <textarea type="text" id="content" name="content" value="" placeholder="请填写内容" style="width: 100%;height: 50%"></textarea>
                                </div>
                                <!-- /.form-group -->
                                <!-- /.form-group -->
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>对象</label><br/>
                                    <select id="to" name="to" class="form-control select2" style="width: 40%;">
