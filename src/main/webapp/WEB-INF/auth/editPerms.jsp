                    ...
                    <!-- form start -->
                        <div class="box-body">
                            <div class="form-group col-xs-6">
                                ...
                                <input type="text" class="form-control" id="roleId" placeholder="${rolePermission.role.id}" disabled>
                            </div>
                            <div class="form-group  col-xs-6">
                                <label for="roleName">角色英文名</label>
                                <input type="text" class="form-control" id="roleName" placeholder="请输入英文..." value="${rolePermission.role.role}" >
                            </div>
                            <div class="form-group  col-xs-6">
                                <label for="description">角色中文描述</label>
                                <input type="text" class="form-control" id="description" placeholder="请输入中文..." value="${rolePermission.role.description}" >
                            </div>
                            <div class="form-group col-xs-6">
...
<script>
    ...
    $(function(){
        ...
        var checkPerms =${rolePermission.permissionString};
        for(var o in checkPerms){
            var node = treeObj.getNodeByParam("id",checkPerms[o].id,null);
            node.checked =true;
