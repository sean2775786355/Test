                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>耗材名称</label>
                      <input id="name" name="name" type="text" placeholder="请填写耗材名称" value="" class="form-control"></input>
                    </div>
                    <div class="form-group">
                      <label>耗材类型</label>
                      <input id="type" name="type" type="text" placeholder="请填写耗材类型" value="" class="form-control"></input>
                    </div>
                     <div class="form-group">
                      <label>级别</label>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>耗材编号</label>
                      <input type="text" id="code" name="code" placeholder="请填写耗材编号" value="" class="form-control"></input>
                    </div>
                     <div class="form-group">
                      <label>标准号</label>
                    ...
                    <div class="form-group">
                      <label>单价</label>
                      <input type="text" id="cost" name="cost" placeholder="请填写耗材单价" value="" class="form-control"></input>
                    </div>
                  </div>
                  <!--第三列-->
                  <div class="col-md-4">
                    ...
                    <div class="form-group">
                      <label>耗材规格</label>
                      <input type="text" id="standard" name="standard" placeholder="请填写耗材规格" value="" class="form-control"></input>
                    </div>
                    <div class="form-group">
                      <label>计算币种</label>
...
<script>
  ...
  $(function () {
    ...
    function  submit(data) {
        ...
        $.ajax({
            url: root+'/consumable/consumablePost',
            type: 'POST',
            dataType: 'json',
            data: data,
        }).done(function (data) {
