    ...
    <div class="content-wrapper">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>资料名称</label>
                      <input type="hidden" id="id" name="id" placeholder="请填写资料id" value="${document.id}" class="form-control"></input>
                      <input type="text" id="name" name="name" placeholder="请填写资料名称" value="${document.name}" class="form-control"></input>
                    </div>
                    <div class="form-group">
                      <label>出版社</label>
                      <input type="text" id="publish" name="publish" placeholder="请填写出版社名称" value="${document.publish}" class="form-control"></input>
                    </div>
                    <div class="form-group">
                      <label>计量单位</label>
                      <c:if test=""></c:if>
      ...
      <c:if test="${document.currency==11}"><option value="11" selected="selected">卢布</option></c:if>    
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>作者</label>
                      <input type="text" id="author" name="author" placeholder="请填写作者名称" value="${document.author}" class="form-control"></input>
                    </div>
                    <div class="form-group">
                      <label>数量</label>
                      <input type="text" id="num" name="num" placeholder="请填写资料数量" value="${document.num}" class="form-control"></input>
                    </div>
                    <div class="form-group">
                      <label>单价</label>
                      <input type="text" id="cost" name="cost" placeholder="请填写资料单价" value="${document.cost}" class="form-control"></input>
                    </div>
                    <div class="form-group">
                      <div id="div_boat">
                        <label>所属船舶</label>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group date">
                        ...
                        <input type="text" class="form-control pull-right" id="work_date" name="work_date" value ="${document.work_date}"/>
                      </div>
                    </div>
                    <div class="form-group">
                      <label>备注说明</label>
                      <textarea type="text" id="content" name="content" value="${document.content}" placeholder="请填写资料备注说明" style="width: 100%;">${document.content}</textarea>
                    </div>
                  </div>
                  <!--第二列-->
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group date">
                        ...
                        <input type="text" class="form-control pull-right" id="out_date" name="out_date" value = "${document.out_date}"/>
                      </div>
                    </div>
                  </div>
                </div>
...
$(function () {
    ...
    function  submit(data) {
        ...
        $.ajax({
            url: root+'/document/documentUpdateCheck',
            type: 'POST',
            dataType: 'json',
            data: data,
        }).done(function (data) {
