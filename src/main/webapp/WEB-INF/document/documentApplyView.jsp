    ...
    <div class="content-wrapper">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>资料名称</label>
                      <input disabled="true" type="text" id="name" name="name" placeholder="请填写资料名称" value="${documentApply.name}" class="form-control"></input>
                    </div>
                    <div class="form-group">
                      <label>出版社</label>
                      <input disabled="true" type="text" id="publish" name="publish" placeholder="请填写出版社名称" value="${documentApply.publish}" class="form-control"></input>
                    </div>
                    <div class="form-group">
                      <label>计量单位</label>
                      <c:if test=""></c:if>
      ...
      <c:if test="${documentApply.unit==18}"><option value="18" selected="selected">其他3</option></c:if>      
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>作者</label>
                      <input disabled="true" type="text" id="author" name="author" placeholder="请填写作者名称" value="${documentApply.author}" class="form-control"></input>
                    </div>
                    <div class="form-group">
                      <label>数量</label>
                      <input disabled="true" type="text" id="num" name="num" placeholder="请填写资料数量" value="${documentApply.num}" class="form-control"></input>
                    </div>
                    <div class="form-group">
                      <div id="div_boat">
                        <label>所属船舶</label>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group date">
                        ...
                        <input disabled="true" type="text" class="form-control pull-right" id="pre_date" name="pre_date" value ="${documentApply.pre_date}"/>
                      </div>
                    </div>
                    <div class="form-group">
                      <label>备注说明</label>
                      <textarea disabled="true" type="text" id="content" name="content" value="${documentApply.content}" placeholder="请填写资料备注说明" style="width: 100%;">${documentApply.content}</textarea>
                    </div>
                    <div class="form-group">
                      <label>审核说明</label>
                      <textarea disabled="true" type="text" id="content" name="content" value="${documentApply.content_check}" placeholder="请填写资料审核说明" style="width: 100%;">${documentApply.content_check}</textarea>
                    </div>
                  </div>
                  <!--第二列-->
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>预期地点</label>
                      <input disabled="true" type="text" id="pre_local" name="pre_local" placeholder="请填写预期地点" value="${documentApply.pre_local}" class="form-control"></input>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
