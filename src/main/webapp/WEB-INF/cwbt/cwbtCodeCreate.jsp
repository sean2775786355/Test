...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <!-- SELECT2 EXAMPLE -->
            <!-- form  -->
            <form action="${pageContext.request.contextPath}/cwbt/cwbtCreateResult" method="post" role="form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="cwbt_1" name="cwbt_1" class="form-control select2" style="width: 20%;">
                                        <c:forEach items="${list1}" var="subCwbt" >
                                        <option value="${subCwbt.code}">${subCwbt.code}</option>
                                        </c:forEach>
                                    </select>
                                    &nbsp; &nbsp; &nbsp;
                                    <select id="cwbt_2" name="cwbt_2" class="form-control select2" style="width: 30%;">
                                        <c:forEach items="${list2}" var="subCwbt" >
                                            <option value="${subCwbt.code}">${subCwbt.code}</option>
                                        </c:forEach>
                                    </select>
                                    &nbsp; &nbsp; &nbsp;
                                    <select id="cwbt_3" name="cwbt_3" class="form-control select2" style="width: 30%;">
                                ...
                                <div class="form-group">
                                    <label>设备说明</label>
                                    <textarea type="text" id="content" name="content" value="" placeholder="请填写设备说明"
                            ...
                            <div class="form-group">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" id="service_level_a_content" name="A" value="" placeholder="请填写A类维护内容" style="width: 100%;"></textarea>
                                        <br/><br/>
                                        <label>
                                            E
                                        </label>
                                        <textarea type="text" id="service_level_e_content" name="E" value="" placeholder="请填写E类维护内容" style="width: 100%;"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <br/>
                                    ...
                                    <textarea type="text" id="service_level_b_content" name="B" value="" placeholder="请填写B类维护内容" style="width: 100%;"></textarea>
                                    <br/><br/>
                                    <label>
                                        F
                                    </label>
                                    <textarea type="text" id="service_level_f_content" name="F" value="" placeholder="请填写F类维护内容" style="width: 100%;"></textarea>
                                </div>
                                <div class="col-md-3">
                                    <br/>
                                    <label>
                                    ...
                                    <textarea type="text" id="service_level_c_content" name="C" value="" placeholder="请填写C类维护内容" style="width: 100%;"></textarea>
                                    <br/><br/>
                                    <label>
                                        G
                                    </label>
                                    <textarea type="text" id="service_level_g_content" name="G" value="" placeholder="请填写G类维护内容" style="width: 100%;"></textarea>
                                </div>
                                <div class="col-md-3">
                                    <br/>
                                    <label>
                                    ...
                                    <textarea type="text" id="service_level_d_content" name="D" value="" placeholder="请填写D类维护内容" style="width: 100%;"></textarea>
                                    <br/><br/>
                                    <label>
                                        H
                                    </label>
                                    <textarea type="text" id="service_level_h_content" name="H" value="" placeholder="请填写H类维护内容" style="width: 100%;"></textarea>
                                </div>
                            </div>
                        </div>
                        <!-- /.row -->
