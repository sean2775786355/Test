...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <!-- SELECT2 EXAMPLE -->
            <!-- form  -->
            <form action="${pageContext.request.contextPath}/cwbt/subCwbtCreateResult" method="post" role="form" id="form"
                  >
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="hidden" id="hidden" name="cwbt_" value="1">
                                    <label>子代码类别</label>
                                    <select id="cwbt" name="cwbt" class="form-control select2" style="width: 100%;">
                                        <option value="cwbt_1" selected="selected">代码一</option>
                                        <option value="cwbt_2">代码二</option>
                                        <option value="cwbt_3">代码三</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>子代码</label>
                                    <input class="form-control" type="text" id="code" name="code" maxlength="3"
                                           placeholder="请输入子代码"></input>
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group">
                                    <label>设备说明</label>
