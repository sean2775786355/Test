...
<div class="wrapper">
  ...
  <!--        <form method="POST" id="" name="" action="" role="form"> -->
      ...
      <c:if test="${materiel.duty==82}"><option value="82" selected="selected">其他3</option></c:if>
      <c:if test="${materiel.duty==83}"><option value="83" selected="selected">岸基管理员</option></c:if>
