...
其他说明：${materiel.content}
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <label>入库数量</label>
                                            <input disabled="disabled" type="text" id="income_count" name="income_count" class="form-control" placeholder="请填写入库数量" value="${materielPurchase.currentCount}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label>入库说明</label>
                                            <textarea disabled="disabled" type="text" id="income_content" name="income_content" value="" style="width: 100%;">${materielPurchase.incomeContent}</textarea>
                                        </div>
                                    </div>
                                </div>
