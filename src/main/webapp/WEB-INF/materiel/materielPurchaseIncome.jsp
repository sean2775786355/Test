        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <form method="post" id="" name="" role="form" action="${pageContext.request.contextPath}/materiel/materielPurchaseIncomeDo">
                            <input hidden="hidden" id="id" name="applyId" value="${materielApply.id}"/>
                            <input hidden="hidden" name="boatId" value="${materielApply.boat_id}"/>
                            <input hidden="hidden" name="materielId" value="${materiel.id}"/>
...
其他说明：${materiel.content}
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <label>入库数量</label>
                                            <input type="text" id="incomeCount" name="incomeCount" class="form-control" placeholder="请填写入库数量" value="${materielPurchase.currentCount}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>大单审核人</label>
                                            <c:if test="${materielPurchase.status==3}">
