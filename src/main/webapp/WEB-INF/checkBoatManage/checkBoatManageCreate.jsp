            ...
            <!-- form  -->
                <div class="box box-default">
                    <div class="box-header with-border">
                        ...
                        <input type="hidden" id="isForBoat" name="isForBoat" value="1"></input>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>主题</label>
                                    <input class="form-control" type="text" id="subject" name="subject" placeholder="请输入主题"></input>
                                </div>
                                <div class="form-group">
                                    <label>内容</label>
                                    <textarea type="text" id="content_send" name="content_send" value="" placeholder="请填写内容" style="width: 100%;height: 50%"></textarea>
                                </div>
                                <!-- /.form-group -->
                                <!-- /.form-group -->
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>对象</label><br/>
                                    <select id="boatId" name="boatId" class="form-control select2" style="width: 40%;">
...
<script>
	...
	function getParms(){
    	...
    	var content_send = $('#content_send').val();
    	var boatId = $('#boatId').val();
    	

        var data ={
        	"subject" : subject,
            "contentSend" : content_send,
            "boatId" : boatId
        }
        return data;
    }
    ...
    function  submit(data) {
        ...
        $.ajax({
            url: root+'/checkBoatManage/checkBoatManagePost',
            type: 'POST',
            dataType: 'json',
            data: data,
        }).done(function (data) {
