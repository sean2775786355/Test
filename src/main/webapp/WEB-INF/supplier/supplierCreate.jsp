                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>供应商名称</label>
                      <input id="supplier_name" name="supplier_name" type="text" placeholder="请填写供应商名称" value="" class="form-control"></input>
                    </div>
                    <div class="form-group">
                      <label>供应商电话</label>
                      <div class="input-group">
                        ...
                        <input type="text" id="company_phone" name="company_phone" placeholder="请填写供应商电话" value="" class="form-control"></input>
                      </div>
                    </div>             
                     <div class="form-group">
                      <label>联系人姓名</label>
                      <input type="text" id="linkman_name" name="linkman_name" placeholder="请填写联系人姓名" value="" class="form-control"></input>
                    </div>                   
                  </div>
                  <!--第二列-->
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>公司法人</label>
                      <input type="text" id="principal" name="principal" placeholder="请填写公司法人" value="" class="form-control"></input>
                    </div>
                     <div class="form-group">
                      <label>供应商传真</label>
                      <div class="input-group">
                        ...
                        <input type="text" id="fax" name="fax" placeholder="请填写供应商传真" value="" class="form-control"></input>
                      </div>
                    </div>          
                    <div class="form-group">
                      <label>联系人电话</label>
                      <div class="input-group">
                        ...
                        <input type="text" id="linkman_moblie_phone" name="linkman_moblie_phone" class="form-control"></input>
                      </div>
                    </div>                     
                  </div>
                  <!--第三列-->
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>供应商邮箱</label>
                      <input type="text" id="email" name="email" placeholder="请填写供应商邮箱" value="" class="form-control"></input>
                    </div>
                    <div class="form-group">
                      <label>供应商类型</label>
                      <input type="text" id="company_type" name="company_type" placeholder="请填写供应商类型" value="" class="form-control"></input>
                    </div>
                  </div>
                </div>
                <div class="row">
...
<script>
  ...
  //获取人员信息
    ...
    function  submit(data) {
        ...
        $.ajax({
            url: root+'/supplier/supplierPost',
            type: 'POST',
            dataType: 'json',
            data: data,
        }).done(function (data) {
