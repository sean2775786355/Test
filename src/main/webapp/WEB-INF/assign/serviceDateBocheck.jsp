...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <!--  工作卡一-->
            <input type="hidden" id="urll" value="${pageContext.request.contextPath}/Assign/serviceDateBocheckNo"/>
            <% int i=1; %>
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    ...
                    <c:if test="${serviceDateAll.checkStatus=='6'}">
                        &nbsp; &nbsp; &nbsp;审核未通过
                    </c:if>
                ...
                <!-- /.box-header -->
                <form method="post" id="1-1" name="1-1" action="${pageContext.request.contextPath}/Assign/serviceDateBocheckOk" role="form">
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>设备名称</label>
                                    <input type="hidden" name="boatId" value="${serviceDateAll.boatId}">
                                    <input type="text" disabled="disabled" class="form-control" id="equipment_id" name="equipment_id" value="${serviceDateAll.equipmentName}" style="width: 100%;"/>
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group">
                                    <label>维护级别</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input disabled="disabled" type="text" class="form-control pull-right" id="did_time" name="did_time" value="${serviceDateAll.didTime}"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>维护报告</label>
                                    <textarea disabled="disabled" type="text" id="content" name="content"  placeholder="请填写维护报告内容" style="width: 100%;">${serviceDateAll.content}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>维护反馈</label>
                                    <textarea type="text" id="check_content" name="checkContent" value="" placeholder="请填写维护退回原因" style="width: 100%;"></textarea>
                                </div>
                                <!-- /.form-group -->
                            </div>
                            <!-- /.col -->
