...
<body>
<!-- Main Header -->
<header class="main-header" id="main-header" data-id="${pageContext.request.contextPath}" data-active="${active}">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header">你有 10 项任务要完成</li>
                        <li>
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <%--  <!-- Menu Body -->
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="${pageContext.request.contextPath}/system/changePassword" class="btn btn-default btn-flat">修改密码</a>
                            </div>
